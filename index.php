...
<body>
  ...
  <div class="container">
    ...
    <h1 class="my-4 text-center">Bem vindo ao DoeFácil</h1><br>
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-6 portfolio-item">
        <div class="h-100">
          ...
          <div class="card-body">
            <h4 class="card-title">
              <a class="nav-link text-success" href="#">Nome Projeto</a>
            </h4>
            <p class="card-text">Aqui vamos falar um pouco do projeto.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-sm-6 portfolio-item">
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; <a href="admin/login.php" class="text-white text-decoration-none">DoeFácil</a> 2019</p>
    </div>
    <!-- /.container -->
  </footer>
